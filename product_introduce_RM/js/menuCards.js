document.addEventListener("DOMContentLoaded", function () {
  ...
  const data = [
    { flag: "wagyu", name: "和牛ロース" },
    { flag: "wagyu", name: "和牛カルビ" },
    { flag: "wagyu", name: "和牛モモロース" },
